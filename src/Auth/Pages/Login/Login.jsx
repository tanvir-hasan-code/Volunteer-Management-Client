...
const Login = () => {
  ...
  return (
    <div className="hero bg-base-200 min-h-screen">
      <div className="card bg-base-100 w-11/12 mx-auto my-14 lg:my-0 lg:w-full max-w-lg shrink-0 shadow-2xl">
        <div className="card-body">
          <h1 className="text-3xl text-center font-bold">Please Login now!</h1>
